//Script closing NOC TT. Made by Andrew Rudenko. 24.12.21 
...
for(let i=0;i< COUNT;i++){await close_one_TT();console.log("%cУспешно закрыты %s TT","color:blue", i+1);console.log("%cСпасибо Андрюхе Руденко !!!","color:green");}
}
